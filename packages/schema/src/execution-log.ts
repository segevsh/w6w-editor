...
export const executionLogEntrySchema = z.object({
  timestamp: z
    .number()
    .describe("Unix timestamp in milliseconds when the log entry was created"),
  ...
  nodeId: z
    .string()
    .optional()
    .describe("Node ID if this log is related to a specific node"),
  ...
  data: z
    ...
    .optional()
    .describe("Additional structured data associated with this log entry"),
  ...
  error: z
    ...
    .optional()
    .describe("Error details if this log entry represents an error"),
});
...
export const executionLogSchema = z.object({
  ...
  completedAt: z
    ...
    .optional()
    .describe(
      "Unix timestamp in milliseconds when execution completed (success or failure)"
    ),

  entries: z
    .array(executionLogEntrySchema)
    .describe("Chronological list of log entries"),
  ...
  metadata: z
    .object({
      triggeredBy: z
        .string()
        .optional()
        .describe("User or system that triggered the execution"),
